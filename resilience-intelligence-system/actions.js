...
window.ACT = (function () {
  ...
  const PLAYS = [
    ...
    /* ---- 2 · LOGISTICS — Fujairah import bypass --------------------------- */
    {
      ...
      premortem: [
        ...
        { mode: "The standing costs quietly burn through the budget", likelihood: "High",
          ...
          mitigation: "Keep the expensive air lane for genuinely urgent goods only (medicines, chips); everything else waits for shipping to recover. Air freight always costs many times more per ton: a permanent premium, not a one-off." },
      ],
    },
    ...
    /* ---- 5 · FINANCE — sovereign import-stabilization facility ------------ */
    {
      ...
      precedent: {
        ...
        facts: [
          ...
          "It proved the two things this plan needs: the UAE can mobilize a large backstop fast, and can run it through existing machinery with rules and an end date",
        ],
        sources: [
    ...
    /* ---- 6 · DEFENSE/TECH — compute under the open window ------------------ */
    {
      ...
      thesis: "What limits advanced chips isn't money. It's US export licenses. The UAE can buy chips today under the UAE–US AI agreement, and the plan keeps that access working while cutting how much rides on it. It runs on two clocks at once. A stockpile stands up quickly (months) to hold a comfortable buffer. Home-grown manufacturing follows on a realistic horizon (years). The end state: a country that sources chips from strength, not dependence, while still buying the most cutting-edge chips abroad where that makes sense.",
      site: {
      ...
      tech: {
        ...
        inputs: [
          ...
          { name: "Specialist engineers", status: "imported", note: "the hardest input to find; staff exchanges must be written into the deal" },
        ],
      },
      partners: [
      ...
      tiers: [
        ...
        },
        {
          ...
          costBasis: "Similar chip campuses cost about US$1–2bn to build worldwide, so roughly AED 7bn here. This is the realistic middle step: not the most advanced chip-making, but well beyond just stockpiling.",
        ...
        },
        {
          ...
          milestones: [["Y1", "Partner equity closed · site works"], ["Y3", "Factory shell + tooling installed"], ["Y5", "Older-generation wafers in production"]],
        },
      ],
      premortem: [
        { mode: "Washington changes its mind", likelihood: "Low",
          ...
          mitigation: "Policy keeps moving in the UAE's favor (Nov 2025 G42 approval, Jul 2026 export-status upgrade), so likelihood is low. But it is still policy, not law, and could be reversed by a change in administration. Qualify chips from allied factories too as a hedge." },
        { mode: "Chasing a chip factory beyond realistic reach", likelihood: "High",
          indicator: "The gap between what the UAE could realistically make and what it needs", tracked: false,
          mitigation: "Aim at the realistic steps: finishing, testing, and older-generation chips through GlobalFoundries, and cover the cutting edge with the stockpile plus alliances. Only a handful of firms can make the most advanced chips; no plan changes that." },
    ...
    /* ---- 7 · FOOD — grow the essentials indoors --------------------------- */
    {
      ...
      tiers: [
        ...
        },
        {
          ...
          deliverable: "Make the farms' own supplies at home, so food production stops depending on weekly imports. Four parts: a regional seed bank and breeding program, so indoor farms grow their own seeds instead of buying them abroad; plant nutrients blended locally from the ammonia and urea the UAE already makes (Fertiglobe); more fish farming, because fish turn feed into food about twice as efficiently as land animals, so it needs less imported feed; and turning insects and food waste into part of the animal feed to replace some imports.",
          ...
          residual: "Calories stay globally sourced by design, the end-state is essential fresh nutrition that survives a long blockade, not total self-sufficiency. The honest ceiling for a desert nation.",
